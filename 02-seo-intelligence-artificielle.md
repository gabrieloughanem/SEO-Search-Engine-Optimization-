...
## Recherche générative et moteurs de réponse

Les moteurs de recherche traditionnels présentent principalement une liste de résultats permettant à l'utilisateur de consulter différentes pages. Les systèmes de recherche générative et les moteurs de réponse peuvent, eux, produire directement une réponse synthétisée à partir d'informations provenant de différentes sources, parfois accompagnée de liens ou de citations permettant de consulter les documents utilisés.

Cette évolution modifie la manière dont l'information peut être découverte et consultée sur le Web. Une page peut ainsi être utile non seulement parce qu'elle apparaît dans une page de résultats, mais également parce que son contenu peut être utilisé comme source ou référence dans une réponse générée.
...
Les expressions GEO (Generative Engine Optimization) et AEO (Answer Engine Optimization) sont utilisées pour désigner différentes approches visant à améliorer la visibilité d'un contenu dans des réponses générées ou des moteurs de réponse.

Ces termes sont récents et ne disposent pas d'une définition technique universellement établie. Ils ne désignent donc pas nécessairement des mécanismes distincts du SEO traditionnel.
